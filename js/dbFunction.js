...
function addEvent() {
  ...
  //  var privacy = document.getElementsByName("privacy");
    ...
    //     }
    // }
     addEventToDatabase(event_name.value, description.value, date.value, time.value, selected_schedule);
     //privacy_policy
}
// Function to retrieve data from the forms end

// Function to pass data to the database start
function addEventToDatabase(event_name, description, date, time, schedule) {
